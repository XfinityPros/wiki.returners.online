...
| **Villain** | **Abyssal Sanctuary** in the underworld |
...
Because both heroes and villains may need to use the Returners’ Gate, the world center is usually dangerous and highly contested.
...
In Returners Rest, heroes and villains arrive at the same shared sanctuary instead of separate hero and villain safe zones.
...
| **Villain spawn**   | Shared sanctuary                                                      |
| **Safe zone split** | Heroes and villains are not separated by default.                     |
| **Main purpose**    | Safer world, easier learning, lower conflict, and shared exploration. |

Other summoned worlds may still separate heroes and villains into different safe zones.
